...
public class MostrarLlistaPlataformes extends AppCompatActivity {
    ...
    private void loadData(String url) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(url,
                response -> {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            elements.add(new Plataforma(
                                    obj.getInt("id"),
                                    obj.getString("slug"),
                                    obj.getString("name"),
                                    obj.optInt("games_count"),
                                    obj.optString("image_background"),
                ...
                error -> Toast.makeText(MostrarLlistaPlataformes.this, "Error en obtenir dades", Toast.LENGTH_SHORT).show());
        queue.add(request);
    }
}